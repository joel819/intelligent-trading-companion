          ...
          ticks.slice(0, 15).map((tick, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 font-mono text-xs">
                <span className="text-success">{tick.bid.toFixed(tick.symbol.includes('JPY') ? 3 : 5)}</span>
                <span className="text-destructive">{tick.ask.toFixed(tick.symbol.includes('JPY') ? 3 : 5)}</span>
